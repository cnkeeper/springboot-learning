...
public abstract class SpringBootCondition implements Condition {
	...
	public final boolean matches(ConditionContext context,
		...
		try {
			...
			System.out.println("SpringBootCondition matches:"+classOrMethodName+", return:"+match);
//			if(classOrMethodName.contains("testCondition")){
//				System.out.println(">>>>>>>>>>>>>>>>>>>>>SpringCondition<<<<<<<<<<<<<<<<<<<<<<<<<<<");
