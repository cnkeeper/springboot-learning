package com.github.cnkeep.common.util.date;
...
public class DateUtil {
    ...
    public static final String getCurrentDateTime(){
        return LocalDateTime.now().format(FORMATTER_MAP.get(DateType.DATE_TIME));
    }
     ...
     * @return
     */
    public static final String getPreDays(int preDays){
        return LocalDate.now()
                .minusDays(preDays)
                .format(FORMATTER_MAP.get(DateType.DATE));
    }
     ...
     * @return
     */
    public static final String getPreMonth(int preMonths){
        return LocalDate.now()
                .minusMonths(preMonths)
                .format(FORMATTER_MAP.get(DateType.DATE));
    }
}
